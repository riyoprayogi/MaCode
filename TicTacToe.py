# Test Game Tic Tac Toe
from tkinter import *
import tkinter.messagebox
tk = Tk()
tk.title("Game Triple T")
pa = StringVar()
playerb = StringVar()
p1 = StringVar()
p2 = StringVar()
...
def btnClick(buttons):
    ...
    if buttons["text"] == " " and bclick == True :
        ...
        tkinter.messagebox.showinfo("Tic-Tac-Toe", "Button nya Sudah di Klik BOS!")
...
def checkForWin():
    if (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
        ...
        tkinter.messagebox.showinfo("Tic-Tac-Toe", "SERI, CUPU AH!")
        ...
        disableButton()
        tkinnter.messagebox.showinfo("Tic-Tac-Toe", playerb)
